...
## 📁 LinkedIn CSV Import (Resume Generator)

The resume generator reads your real LinkedIn data. To get your files:

1. Go to LinkedIn → Settings & Privacy → Data Privacy → Get a copy of your data
2. Select Profile, Positions, Skills and Education — click Request Archive
3. Download the ZIP from your email and extract it
4. Upload the CSV files directly into the Resume tab

---

## 🌍 Live Demo

👉 [Open Remote Job Bot Pro](https://wisdomkings001.github.io/remote-job-bot)
...
Instagram — [@kingswisdom935](https://www.instagram.com/kingswisdom935?igsh=NGlhNjh2eW8wdDVt)
